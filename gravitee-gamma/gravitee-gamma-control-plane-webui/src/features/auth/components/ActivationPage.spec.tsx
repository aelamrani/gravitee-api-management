...
describe('ActivationPage', () => {
    ...
    it('puts a refused password on the password field and retires it once the password changes', async () => {
        ...
        const message = await screen.findByText('The password is not valid according to policy rules.');
