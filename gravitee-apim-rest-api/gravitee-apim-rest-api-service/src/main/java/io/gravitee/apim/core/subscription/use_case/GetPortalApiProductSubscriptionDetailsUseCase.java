...
public class GetPortalApiProductSubscriptionDetailsUseCase {
    ...
    private ApiSummary toApiSummary(
        ...
        return new ApiSummary(
            ...
            availability,
            entrypoints,
            resolveDocumentationTarget(navigationItems, input, navigationAncestorsById)
        );
    }
    ...
    private DocumentationTarget resolveDocumentationTarget(
        ...
        return navigationItems
            .stream()
            .filter(item -> isAccessibleFromSubscribedProduct(item, input, navigationAncestorsById))
