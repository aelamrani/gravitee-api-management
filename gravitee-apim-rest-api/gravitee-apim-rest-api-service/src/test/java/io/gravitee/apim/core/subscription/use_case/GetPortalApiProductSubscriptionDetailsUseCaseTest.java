...
class GetPortalApiProductSubscriptionDetailsUseCaseTest {
    ...
    void setUp() {
        ...
        useCase = new GetPortalApiProductSubscriptionDetailsUseCase(
    ...
    private static PortalNavigationApi apiNavigation(PortalNavigationApiProduct productNavigation) {
        var item = PortalNavigationItemFixtures.anApi(API_NAVIGATION_ID, "API", productNavigation.getId(), API_ID);
