    ...
    @CsvSource(
        {
            ...
            "v4 metrics without api name, v4.metric.Metrics, v4/metrics-without-api-name.json, elasticsearch/v4/metrics-without-api-name.json",
    ...
    @CsvSource(
        {
            ...
            "v4 metrics without api name, v4.metric.Metrics, v4/metrics-without-api-name.json, elasticsearch/v4/metrics-without-api-name.jsonl",
